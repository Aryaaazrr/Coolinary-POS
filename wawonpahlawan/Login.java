...
public class Login extends javax.swing.JFrame {
    ...
    private void btnMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMasukActionPerformed
        try{
            //query
            String sql = "SELECT * FROM tb_kasir WHERE nama_pengguna='"+ usernameField.getText()+"' AND kata_sandi='"+passwordField.getText()+"'";
            //menjalankan query
        ...
        //*
            if(rs.next() && usernameField.getText().equals(rs.getString("nama_pengguna"))
                ...
                this.nama = rs.getString("nama_kasir");
                this.idkasir = rs.getString("id_kasir");
