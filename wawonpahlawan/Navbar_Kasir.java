...
public class Navbar_Kasir extends javax.swing.JFrame {
    ...
    private void btnTransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTransaksiMouseClicked
        Transaksi transaksi = new Transaksi();//instansiasi class Transaksi
        ...
        DesktopPane.add(transaksi).setVisible(true);//add item yang sudah di set pada dekstop pane
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Navbar_Kasir().setVisible(true);
            }
        });
    }
