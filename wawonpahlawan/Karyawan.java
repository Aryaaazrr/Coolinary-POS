...
public class Karyawan extends javax.swing.JInternalFrame {
    ...
    public void idkaryawan() {
        try {
            ...
            String sql = "SELECT MAX(id_kasir)as max FROM tb_kasir";
...
//                String AN = "" + (Integer.parseInt(txt_idsupplier.getText()) + 1);
    ...
    public static void tampilkan() {
        ...
        try{
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM tb_kasir");
            while(rs.next()){
...
//            String tanggallahir = String.valueOf(fm.format(txt_tanggallahir.getDate()));
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO tb_kasir VALUES('"+idkaryawan+"', '" + nama + "','"+jk+"','"+alamat+"','"+Long.parseLong(txt_nohp.getText())+"','"+namapengguna+"','"+katasandi+"','kasir')");
            ps.execute();
...
//            System.out.println(tgllahir);
    ...
    private void btnHapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnHapusMouseClicked
            try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_coolinarypos","root","");
            PreparedStatement ps = con.prepareStatement("DELETE FROM tb_kasir WHERE id_kasir = '"+this.selectedKaryawanID+"'");
            ps.execute();
    ...
    private void tb_karyawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_karyawanMouseClicked
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_coolinarypos","root","");
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM tb_kasir WHERE id_kasir ='"+this.selectedKaryawanID+"'");
            while(rs.next()){
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        try{
            ...
            String nohp=txt_nohp.getText();
            String alamat=txt_alamat.getText();
            PreparedStatement ps = con.prepareStatement("UPDATE tb_kasir SET nama_kasir ='"+nama+"', jenis_kelamin = '"+jk+"', alamat_kasir = '"+alamat+"', nohp_kasir='"+nohp+"'WHERE id_kasir = '"+idkaryawan+"'");
            ps.execute();
    ...
    private void txt_cariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cariKeyReleased
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_coolinarypos","root","");
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM tb_kasir WHERE nama_kasir LIKE '%"+txt_cari.getText()+"%'");
            while(rs.next()){
                String data [] = {rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)};
                model.addRow(data);
            }
